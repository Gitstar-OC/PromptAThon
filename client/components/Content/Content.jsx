  ...
  return (
    <div className="max-w-4xl mx-auto py-16 text-gray-900 dark:text-gray-100">
      {Object.values(prompts).map((prompt, index) => (
        <div key={index} className="my-16 border-b border-green-500 shadow-[0_4px_6px_rgba(0,255,0,0.5)] dark:shadow-[0_1px_2px_rgba(0,255,0,0.3)] pb-8">
          <div className="image-container items-center justify-center flex">
            <Image
              ...
              width={700}
              height={350}
              className="rounded-lg transition-transform duration-700 ease-out cursor-pointer"
              onClick={() => {
...
function AnimatedAccordionItem({ title, content, value, isOpen }) {
  ...
  return (
    <AccordionItem value={value} className={`border-b  w-[40rem] border-green-500 rounded-xl ${isOpen ? "bg-gray-100 dark:bg-neutral-900" : ""}`}>
      <AccordionTrigger className="text-lg text-neutral-900 dark:text-gray-300 font-medium py-4 px-2 hover:bg-gray-100 dark:hover:bg-neutral-900 transition-colors rounded-xl">
        {title}
      </AccordionTrigger>
